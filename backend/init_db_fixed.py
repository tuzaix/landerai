...
async def create_database():
    ...
    try:
        ...
        async with engine.connect() as conn:
            # Create database
            await conn.execute(
                text("CREATE DATABASE IF NOT EXISTS landerai CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci")
            )
            await conn.commit()
            print("Database 'landerai' created successfully")
...
async def main():
    ...
    print("=" * 50)
    print("Database: mysql://root:root@127.0.0.1:3306/landerai")
